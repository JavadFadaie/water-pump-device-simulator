...
Registers are written as Input Registers only (function code 04, read-only for Modbus clients). New drivers must use a unique base address (next available: 300).
